...
SELECT fixedresult.oaccode AS O_ACCO_CODE
		...
		UNION ALL
		select ALLOC_CODE O_ACCO_CODE,CUR_AMOUNT linkSumAmount,IYPERIOD from odm.COST_ALLOC_VALUE  where  left (IYPERIOD,4)=left(@max_iyperiod,4) and right(IYPERIOD,2)<right(@max_iyperiod,2)
