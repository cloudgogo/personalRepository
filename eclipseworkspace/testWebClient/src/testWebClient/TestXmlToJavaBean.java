...
import com.webService.util.XmlUtil;

public class TestXmlToJavaBean {
    ...
    String xml= new TestXmlToJavaBean().getxml();
    String needxml=xml.substring(xml.indexOf("<BASIC_SIGEN>"), xml.indexOf("</BASIC_SIGEN>")+14);
    System.out.println("#xml==  "+xml);
    System.out.println("#needxml== "+needxml);
    BASIC_SIGEN baSigen=XmlUtil.converyToJavaBean(needxml, BASIC_SIGEN.class);
    System.out.println(baSigen.getCustname_info().getCust_name());
	}
