...
public class Testlog4j {
	   ...
	   public void test() throws Exception {  
	        ...
	        Document document = reader.read("<?xml version=\"1.0\" encoding=\"UTF-8\"?> \"\"<msg><msgHeader><respType>U</respType><respCode>ESBS9002</respCode><respCodeDec>验证报文格式非法，请求方的请求报文非法[XML document structures must start and end within the same entity.]</respCodeDec></msgHeader></msg>");  
	        //获取根节点元素对象  
	    ...
	    public void writer(Document document) throws Exception {  
	        ...
	        XMLWriter writer = new XMLWriter(new OutputStreamWriter(new FileOutputStream("src//a.xml"), "UTF-8"), format);  
	        // 写入  
